...
class LocationCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addColumns(['name']); // add multiple columns, at the end of the 
    ...
    public function setPermissions()
    {
        ...
        // Allow list access
        if ($user->can('locations.index')) {
            $this->crud->allowAccess('list');
        }

        // Allow create access
        if ($user->can('locations.create')) {
            $this->crud->allowAccess('create');
        }

        // Allow update access
        if ($user->can('locations.update')) {
            $this->crud->allowAccess('update');
        }

        // Allow delete access
        if ($user->can('locations.delete')) {
